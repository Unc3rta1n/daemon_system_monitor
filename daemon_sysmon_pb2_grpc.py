...
import daemon_sysmon_pb2 as daemon__sysmon__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in daemon_sysmon_pb2_grpc.py depends on'
...
def add_SystemInfoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetSystemStats': grpc.unary_stream_rpc_method_handler(
                    servicer.GetSystemStats,
                    request_deserializer=daemon__sysmon__pb2.SystemStatsRequest.FromString,
                    response_serializer=daemon__sysmon__pb2.SystemStats.SerializeToString,
            ),
    }
