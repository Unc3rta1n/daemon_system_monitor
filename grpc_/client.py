...
def print_system_stats(stats):
    ...
    if stats.top_talkers_traffic:
        # Top Talkers Traffic Stats
        traff_headers = ["src ip", "src port", "dst ip", "dst port", "bps"]
        traff_table = [
            [
                traff.src_ip,
                traff.src_port,
            ...
            for traff in stats.top_talkers_traffic
        ]
        print("\nTraffic Stats:")
